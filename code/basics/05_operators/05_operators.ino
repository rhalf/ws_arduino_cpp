...
void setup() {
  ...
  Serial.println(c >= b);                 // is greater than or equal? 0
  ...
  Serial.println(true || false);          // logical or
  Serial.println(true && false);          // logical and
  Serial.println(!true);                  // logical not
}
